package com.liferay.portlet.facebook.comments.action;
...
public class ConfigurationActionImpl extends BaseConfigurationAction {
	...
	public void processAction(
		...
		String numPosts = ParamUtil.getString(actionRequest, "numPosts");
		String width = ParamUtil.getString(actionRequest, "width");

		preferences.setValue("href", href);
		preferences.setValue("num-posts", numPosts);
	...
	public String render(
		...
		return "/html/comments/configuration.jsp";
	}
